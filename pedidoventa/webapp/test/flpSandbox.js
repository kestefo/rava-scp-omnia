		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pedido Venta",
									"targetURL": "#comravapedidopedidoventa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comravapedidopedidoventa-display": {
								"semanticObject": "comravapedidopedidoventa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.rava.pedido.pedidoventa",
									"url": sap.ui.require.toUrl("com/rava/pedido/pedidoventa")
								}
							}
						}
					}
