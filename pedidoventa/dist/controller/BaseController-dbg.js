sap.ui.define([
	...
	"com/rava/pedido/pedidoventa/controller/Service",
	"sap/ui/core/BusyIndicator",
	"sap/ui/model/json/JSONModel",
	"com/rava/pedido/pedidoventa/model/models",
	"sap/ui/model/Filter",
	"com/rava/pedido/pedidoventa/model/formatter"
	...
	var that;
	var sMessage = "";
	return Controller.extend("com.rava.pedido.pedidoventa.controller.BaseController", {
		formatter: Formatter,
		...
		setFragment: function (sDialogName, sFragmentId, sNameFragment, that) {
			try {
				if (!that[sDialogName]) {
					that[sDialogName] = sap.ui.xmlfragment(sFragmentId, "com.rava.pedido.pedidoventa.view.dialogs." + sNameFragment,
						that);
