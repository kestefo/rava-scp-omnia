sap.ui.define([
	...
	"reportecartera/controller/Service",
	"sap/ui/core/BusyIndicator",
	"sap/ui/model/json/JSONModel",
	"reportecartera/model/models",
	"sap/ui/model/Filter",
	"reportecartera/model/formatter"
	...
	return Controller.extend("reportecartera.controller.BaseController", {
		...
		setFragment: function (sDialogName, sFragmentId, sNameFragment, that) {
			try {
				if (!that[sDialogName]) {
					that[sDialogName] = sap.ui.xmlfragment(sFragmentId, "reportecartera.view.dialogs." + sNameFragment,
						that);
