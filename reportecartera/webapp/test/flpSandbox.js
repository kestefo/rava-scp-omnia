		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#reportecartera-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"reportecartera-display": {
								"semanticObject": "reportecartera",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=reportecartera",
									"url": sap.ui.require.toUrl("reportecartera")
								}
							}
						}
					}
