		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cobranza",
									"targetURL": "#Cobranzaomnia-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Cobranzaomnia-display": {
								"semanticObject": "Cobranzaomnia",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Cobranza.omnia",
									"url": sap.ui.require.toUrl("Cobranza/omnia")
								}
							}
						}
					}
